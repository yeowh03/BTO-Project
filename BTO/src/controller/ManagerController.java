...
/**
 * Provides all management operations for the Manager role:
 * <ul>
...
public class ManagerController implements IManagerServices{
	...
	/**
     * Guides the manager to create a new project, ensuring no overlapping periods.
     *
	...
	/**
     * Allows the manager to edit details of an existing project.
     *
	...
	/**
     * Displays only those projects created by this manager.
     *
	...
	/**
     * Shows all pending officer registrations for manager approval.
     *
	...
	/**
     * Allows manager to approve or reject officer registration requests.
     *
	...
	/**
     * Processes applicant withdrawal requests for booked flats.
     *
	...
	/**
     * Generates and prints a report summarizing current applications
     * and flat booking statistics.
     *
	...
	public void viewAllEnquiries(Manager manager) {
	    ...
	    /**
     * Enables the manager to reply to applicant enquiries.
     *
