...
/**
 * Console‐based menu for Officer users to interact with the system.
 * <p>
 * Options include:
 * <ul>
 *   <li>Register for a project</li>
 *   <li>View registration status</li>
 *   <li>View project details</li>
 *   <li>Process flat selection</li>
 *   <li>Generate booking receipts</li>
 *   <li>View and reply to project enquiries</li>
...
public class OfficerMenu {
    ...
    /**
     * Constructs the OfficerMenu for a given officer.
     *
    ...
    /**
     * Displays the main menu loop and processes user selections.
     * Delegates actions to OfficerController and updates model as needed.
     */
    public void display() {
